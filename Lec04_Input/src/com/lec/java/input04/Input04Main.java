...
import java.util.Scanner;
	public class Input04Main {
		...
		public static void main(String[] args) {
			...
			System.out.println("숫자 3개(int, int, int)를 입력 받으세요.");
			String in1 = sc.next();
			...
			System.out.println("합계 : " + (i1 + i2 + i3));
			
//			TODO
//			실수 3개를 문자열로 입력받아서 (next())
//			실수 3개의 곱을 계산하여 출력하세요.
			
			System.out.println("실수 3개(double, double, double)을 입력 받으세요.");
			double j1 = Double.parseDouble(sc.next());
			double j2 = Double.parseDouble(sc.next());
			double j3 = Double.parseDouble(sc.next());
			
//			Number format Exception = 
			
			System.out.println("결과 : " + (j1 * j2 * j3));
