...
public class RegExp03Main {
	...
	public static void main(String[] args) {
		...
		arrInput = new String[] {
				"The Things",
				"On The Things", // X
				" The The The", // X 공백이 있어도 안됨
				"The The the The" // 매치 1개 : The {0~3}
		};
		...
		arrInput = new String[] {
				...
				"xbz",				
				"xyyz x1y xyyy xxxyyyyyxyxyxxxxxxxxxxxyyyyyyyyyyyyxyxyxyyxyxyyyxxy"
		};
		...
		regex = "ab{3,5}"; // b의 개수가 3 ~ 5개 까지
		
		//─────────────────────────────────────────
		title = " () : ()안에 있는 글자들을 그룹화 ";
		regex = "a(bc)*"; // a뒤에 bc가 없거나 하나 이상일 때. 
		arrInput = new String[] {
				"abc",
				"abcbcbbc",
				"abcabcabc",
		...
		//─────────────────────────────────────────
		title = " | : OR 연산자  역할";
		regex = "a|b"; // a or b 둘 중 하나 
		arrInput = new String[] {
				"a",
				"b",
				"ab",
				"xyz",
				"abcabcbacbacbabcabcabcbabcabcbabcbacbabcbacbabcbabc"
		};
		regex = "(a|b)+";
		...
		regex = "\\s+"; // 공백(스페이스바, 탭, 엔터(줄바꿈))이 1개 이상
		arrInput = new String[] {
				"Hello My World",
				"He \tllo My World",
				"\n\t Hello My World\n\n",
