...
public class String01Main {
	...
	public static void main(String[] args) {
		...
		str1 = str1.concat(str2); // 덮어 쓰기로 변경 가능
		...
		str3 = ""; // empty 문자열, String객채는 존재하지만 비어있는 문자열
		System.out.println(str3.length());
...
//		System.out.println(str1.charAt(20)); //StringIndexOutOfBoundsException
		...
		System.out.println("indexOf(char), indexOf(String)"); // 문자열 안에서 특정 문자(char) 혹은 문자열(String)의 위치(index), 발견 못하면
																// -1 리턴
		System.out.println(str1.indexOf('c')); // 못찾을 시 -1 리턴
		...
		System.out.println(str10.replaceAll("Language", "자바"));		                            // replaceAll() 매칭되는것 전부
