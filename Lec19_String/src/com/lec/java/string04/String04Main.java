...
//		tokenizer.nextToken();  //NoSuchElementException
		...
		StringTokenizer token4 = new StringTokenizer(str5, "-: ");
		...
		StringTokenizer token5 = new StringTokenizer(str6, "+=", true);
		...
		System.out.print(Arrays.toString(expr1));
		StringTokenizer expr2 = new StringTokenizer(Arrays.toString(expr1), "+(*)/-", true);
		while (expr2.hasMoreTokens()) {
			System.out.print(expr2.nextToken());
		}
