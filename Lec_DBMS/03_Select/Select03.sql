...
--3.
SELECT * FROM T_STUDENT WHERE DEPTNO1 = 101 OR DEPTNO1 = 201;
...
--6.
SELECT NAME, HEIGHT, GRADE, WEIGHT FROM T_STUDENT WHERE GRADE = 1 AND WEIGHT >= 80;
--7.
...
--11.
SELECT NAME 이름, HEIGHT 키 FROM T_STUDENT ORDER BY NAME ASC;
--12.
