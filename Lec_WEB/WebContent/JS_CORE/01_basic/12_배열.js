...
var myFuction = function(value){
    console.log(value);
}
cars.forEach(myFuction)
...
console.log(fruits.toString()); // concat 은 원본변화 X

fruits = fruits.concat(['Lemon', 'Banana']);
console.log(fruits.toString()); // 덮어씌우기로 변경
